...
//import { storeEmail } from '../data/database'; not working
...
// stores email via EmaiJS, it collects user email contact, then sends an email for subscribing. 
...
const serviceId = 'service_vwqreb8';
const templateId = 'template_8j8ytps';
const publicKey = '7cdAFLOumCLNZHXVK';

emailjs.send(serviceId, templateId, { recipient: email }, publicKey)
.then((response) => {
